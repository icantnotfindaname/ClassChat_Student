...
public interface ISchedule {
    ...
    interface OnItemBuildListener {
         ...
         * @param schedule      课程实体
         */
        void onItemUpdate(FrameLayout layout, TextView textView, TextView countTextView, Schedule schedule);
    }
    ...
    interface OnConfigHandleListener{
        void onParseConfig(String key, String value, Activity_TimetableView mView);
    }
}
