...
public class OnDateBuildAapter implements ISchedule.OnDateBuildListener {
    ...
    protected View onBuildMonthLayout(LayoutInflater mInflate, int width, int height) {
        View first = mInflate.inflate(R.layout.xml_dateview_moth, null, false);
        //月份设置
        textViews[0] = first.findViewById(R.id.id_dateview_month);
        layouts[0] = null;
    ...
    protected View onBuildDayLayout(LayoutInflater mInflate, int pos, int width, int height) {
        View v = mInflate.inflate(R.layout.xml_dateview_week, null, false);
        ...
        layouts[pos] = v.findViewById(R.id.id_dateview_week_layout);
